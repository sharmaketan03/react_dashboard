  ...
  return (
     <div className="p-6 text-sm font-sans bg-gray-50 min-h-screen">
      ...
      <div className="mb-4 flex justify-between items-center">
        <div>
          <h1 className="text-xl font-bold">Support Ticket #10001</h1>
          <p className="text-gray-500 text-xs">
            Created September 25, 2014 - 12:25am | Claimed by Clark Kelly <a className="text-blue-500">Edit</a>
          </p>
        </div>
      ...
      <div className="flex mb-6">
        <div className="flex-1 text-center bg-blue-500 text-white p-2 rounded-l">Open</div>
        <div className="flex-1 text-center bg-gray-200 p-2">Working</div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="text-xs space-y-2 mb-6">
            ...
            <div className="border-b pb-1">
              ...
              <div className="flex gap-2 mt-1">
                <span className="bg-gray-200 px-2 py-1 rounded">WARRANTY</span>
                <span className="bg-yellow-300 px-2 py-1 rounded">OUT OF WARRANTY</span>
            ...
            <div className="border-b pb-1">
              ...
              <div className="flex gap-2 mt-1">
                <span className="bg-green-400 text-white px-2 py-1 rounded">PARTS REQUIRED</span>
                <span className="bg-gray-200 px-2 py-1 rounded">NO PARTS</span>
              </div>
            </div>
            <div className="flex justify-between border-b pb-1">
              <span className="text-gray-600">Invoice Number</span>
              <span className="text-black font-medium">455647</span>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea className="w-full border mt-1 p-2 rounded" rows="3" readOnly>
          ...
          <div className="bg-white shadow-sm p-4 rounded mb-6">
            <div className="flex justify-between mb-3">
              <div>
                ...
                <p className="text-green-600 text-3xl">2hrs 0mins</p>
          ...
          <div className="bg-white shadow-sm p-4 rounded">
            ...
            <div className="space-y-2">
              <div className="bg-blue-50 p-2 rounded">
                <p className="text-xs text-gray-700">Clark Kelly <span className="text-gray-400 ml-2">Wednesday, June 11 2025 - 3:25PM</span></p>
                <p className="text-sm">dhgf</p>
                <div className="text-right text-xs text-blue-500">Edit | Delete</div>
              </div>
              <div className="bg-blue-50 p-2 rounded">
                <p className="text-xs text-gray-700">Clark Kelly <span className="text-gray-400 ml-2">Tuesday, October 13 2024 - 05:13PM</span></p>
                <p className="text-sm">text</p>
                <div className="text-right text-xs text-blue-500">Edit | Delete</div>
              </div>
              <div className="bg-blue-50 p-2 rounded">
                <p className="text-xs text-gray-700">Clark Kelly <span className="text-gray-400 ml-2">Wednesday, September 11 2024 - 12:23PM</span></p>
                <p className="text-sm">Technician added it nearby...</p>
                <div className="text-right text-xs text-blue-500">Edit | Delete</div>
              </div>
              <div className="bg-blue-50 p-2 rounded">
                <p className="text-xs text-gray-700">Clark Kelly <span className="text-gray-400 ml-2">Wednesday, September 11 2024 - 12:21PM</span></p>
                <p className="text-sm">text</p>
                <div className="text-right text-xs text-blue-500">Edit | Delete</div>
              </div>
            </div>
          ...
          <tbody>
            <tr>
              ...
              <td className="p-2 border">
                <span className="bg-yellow-300 px-2 py-1 rounded">Working</span>
              </td>
            </tr>
            <tr>
              <td className="p-2 border">Event - 25th Aug</td>
